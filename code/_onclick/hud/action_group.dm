...
/datum/action_group/New(datum/hud/new_owner)
	. = ..()
	owner = new_owner
	actions = list()
...
/datum/action_group/proc/insert_action(obj/screen/movable/action_button/action, index)
...
/datum/action_group/proc/remove_action(obj/screen/movable/action_button/action)
	actions -= action
	refresh_actions()
...
/datum/action_group/proc/refresh_actions()
	...
	var/button_number = 0
	for(var/obj/screen/button in actions)
...
/datum/action_group/palette/proc/on_scroll(obj/screen/movable/action_button/button, delta_x, delta_y, location, control, params)
...
/datum/action_group/palette/insert_action(obj/screen/action, index)
	. = ..()
	var/obj/screen/action_palette/palette = owner.toggle_palette
...
/datum/action_group/palette/refresh_actions()
	...
	if(palette.expanded && action_count && our_row_count >= max_rows)
		scroll_down.screen_loc = owner.ui_palette_scroll_offset(actions_above)
		scroll_up.screen_loc = owner.ui_palette_scroll_offset(actions_above)
	else
